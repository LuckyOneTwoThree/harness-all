...
> - ACs marked `[unchanged]` may use a one-line summary + reference to the prior handoff.
> - ACs marked `[added]` or `[modified]` MUST include full description.
> - ACs marked `[superseded]` MUST include pointer to replacement AC ID; superseded ID does NOT appear in `ac_ids`.

| AC ID | Change | Description |
|-------|--------|-------------|
| AC-F01-001 | [added] | <stable Given-When-Then or testable description> |
| AC-F01-002 | [added] | <stable testable description> |
| AC-F02-001 | [added] | <stable testable description; gaps are valid> |
