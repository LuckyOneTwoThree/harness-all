...
| Date | Decision / insight | Reason | Alternatives |
|------|------|------|---------|
...
| Date | Insight | Source | Confidence |
|------|------|------|--------|
| YYYY-MM-DD | [insight description] | [user research / data analysis / competitor analysis] | [0-1.0] |
