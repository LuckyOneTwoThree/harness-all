...
description: Used when generating Persona, Empathy Map, and Journey Map from user voice analysis and behavior analysis results. User modeling auto-generation pipeline.
---
...
- Keywords: user modeling, Persona generation, empathy map, user journey map, user persona, typical user, user role, what users look like
