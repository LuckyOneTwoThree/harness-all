---
name: revenue-funnel
description: Use when analyzing and optimizing the payment conversion funnel. Payment Funnel Auto-Analysis Pipeline analyzes the full-link data from registration to payment, identifies payment barriers, calculates conversion optimization suggestions, and optimizes paywall timing.
---
...
- Keywords: payment funnel, payment conversion, paywall, conversion optimization, payment analysis, unwilling to pay, where payment gets stuck, how to get users to pay
