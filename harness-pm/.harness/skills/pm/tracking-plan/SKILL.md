---
name: tracking-plan
description: Use when you need to generate a tracking plan. Tracking plan auto-generation, including deriving tracking requirements from the metric system, extracting tracking requirements from PRD features, tracking quality checks, and PRD consistency validation.
---
...
- Keywords: tracking plan, event design, property design, tracking specification, Tracking Plan, data collection, add tracking, instrument events
