...
description: Used when validating product solutions. Solution validation sub-module orchestrator, dispatches sub-skills: validation-assumption-map, validation-mvp, validation-experiment, validation-usability.
---
...
- Keywords: solution validation, hypothesis validation, MVP, usability testing, experiment design, assumption map, risk assessment, validate idea, minimum viable product
