...
> **Import Mode decision tables** (Mode Selection, User Decision Options, Decision Recording, Gate Failure Recovery, AC ID Assignment) have been moved to [import-mode-flow.md](import-mode-flow.md) §Import Mode Decision Tables, colocated with the Import Mode execution flow they govern.
