...
description: Used when designing user interview scripts, extracting insights after interviews, or conducting cross-interview clustering analysis. Interview Assist Pipeline.
---
# Interview Assist
...
- Keywords: user interview, interview script, interview insights, semi-structured interview, qualitative research assist, interview outline, interview synthesis, what to talk about with users
...
> See [Reference/interview-script-schema.md](./Reference/interview-script-schema.md) for the interview-script.json schema (script_id, research_objectives, core_modules, opening, closing, recommended_participants), field validation rules, and a complete JSON example.
...
> See [Reference/interview-insights-schema.md](./Reference/interview-insights-schema.md) for the interview-insights.json schema (interviews_conducted, validated/refuted hypotheses, new discoveries, cross-interview patterns, persona updates, data cross-validation, metadata), field validation rules, and a complete JSON example.
