...
description: Used when designing or evaluating a product business model. Business Model Orchestrator, dispatching business-model-canvas/value-fit/pricing/strategy-report.
---
...
- Keywords: business model, business canvas, pricing strategy, business strategy report, how to make money, revenue model, charging model, business assessment
