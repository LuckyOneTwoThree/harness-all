...
description: Used when summarizing competitor tracking data into a complete, deliverable monitoring report. Auto-generates competitor monitoring reports including competitor dynamics summary, feature change tracking, market strategy changes, threat assessment, and response recommendations.
---
...
- Keywords: competitor monitoring report, competitor dynamics, feature tracking, threat assessment, competitor response, competitor report, what are competitors doing
...
> **Consolidate, do not re-analyze.** This step consolidates the threat signals already assessed by `diagnosis-competition` (Step 2: Advantage Dynamic Assessment) into a report-level threat summary. Do NOT re-perform competitive analysis — reference diagnosis-competition's output.

Threat level summary (consolidated from upstream):
1. **Direct threats**: from diagnosis-competition's advantage assessment (competitor features replacing own core)
2. **Indirect threats**: from diagnosis-competition's market strategy analysis
3. **Opportunity windows**: competitor gaps identified upstream
4. **Threat level**: 🔴 Severe / 🟠 High / 🟡 Medium / 🟢 Low (aggregate of upstream per-competitor assessments)

### Step 5: Response Recommendations [Deep]

> **Consolidate, do not re-generate.** This step assembles the response strategies already generated by `diagnosis-competition` (Step 3: Response Strategy Generation) into a report-level timeline view. Do NOT create new response strategies — reference upstream output.

Response timeline (consolidated from upstream):
1. **Immediate response** (1-2 weeks): from diagnosis-competition's P0 response strategies
2. **Short-term response** (1-2 months): from diagnosis-competition's P1 response strategies
3. **Long-term response** (quarterly+): from diagnosis-competition's P2 response strategies
4. **Monitoring enhancement**: competitors/dimensions flagged by upstream as needing closer tracking
