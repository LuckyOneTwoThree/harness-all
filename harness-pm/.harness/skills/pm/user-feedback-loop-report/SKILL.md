...
description: Used when summarizing user feedback handling into a complete, deliverable closed-loop report. Auto-generates user feedback loop reports including feedback source analysis, processing progress tracking, closure rate statistics, unresolved issues, and improvement suggestions.
---
...
- Keywords: user feedback loop, feedback report, feedback tracking, closure rate, VOC loop, feedback handling, is feedback handled, user opinions
