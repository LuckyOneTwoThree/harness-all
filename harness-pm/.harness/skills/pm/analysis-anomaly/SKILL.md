...
| 输入项 | 类型 | 必填 | 来源 | 说明 |
|--------|------|------|------|------|
| 指标体系 | JSON | 是 | docs/metrics/metrics-system.md | 需要监控的核心指标列表及定义 |
...
**输出文件路径**：`docs/metrics/data-analysis-report.md（“异常分析”章节）`
**输出Schema**：
...
anomaly_report:
  ...
  # 辅助信息
  trend_chart_url: "docs/metrics/data-analysis-report.md（“异常分析”章节）
  raw_data_url: "docs/metrics/data-analysis-report.md（“异常分析”章节）
```

### 存储路径

所有异常分析内容写入 `docs/metrics/data-analysis-report.md（"异常分析"章节）`，不创建子目录。
