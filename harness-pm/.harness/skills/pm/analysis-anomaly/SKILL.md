...
description: Use when automatically detecting and attributing metric anomalies. Automated Data Analysis Engine, AI auto-executes 24/7 operation, responsible for metric health checks, anomaly detection, automated attribution, and insight push. Outputs a complete anomaly report when metric anomalies are detected. This skill is suitable for offline anomaly analysis scenarios, not for real-time monitoring.
---
...
- Keywords: anomaly detection, data analysis, automated attribution, metric monitoring, anomaly report, metric anomaly, data anomaly, anomaly alert, data has issues, metric suddenly dropped, data fluctuation
