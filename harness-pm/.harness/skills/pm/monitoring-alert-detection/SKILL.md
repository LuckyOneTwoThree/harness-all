...
description: Used when monitoring product metrics and detecting anomalies. Monitoring alert detection tool responsible for data collection, threshold monitoring, anomaly detection, and alert generation.
---
...
- Keywords: monitoring, alert, anomaly detection, threshold, data collection
