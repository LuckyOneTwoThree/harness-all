...
- Keywords: North Star Metric, core metric, metric selection, product success metric, NSM, key metric, what data to look at
...
> See [Reference/output-schema.md](Reference/output-schema.md) for output validation rules, AI-assisted analysis content, and decision flow.
