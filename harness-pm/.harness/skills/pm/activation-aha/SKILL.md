...
| 输入项 | 类型 | 必填 | 来源 | 说明 |
|--------|------|------|------|------|
| 留存数据 | object | 是 | docs/metrics/data-analysis-report.md（“留存分析”章节） | D1/D7/D30留存率 |
...
**存储路径**：`docs/growth/growth-strategy.md（“Aha Moment”章节）`

**输出文件**：aha_moment.json → `output/metrics/aha-moment.json`
