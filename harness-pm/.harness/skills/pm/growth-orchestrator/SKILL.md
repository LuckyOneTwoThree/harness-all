...
description: Use when you need to formulate a growth strategy or systematically drive growth. The Growth Strategy Orchestrator first diagnoses the growth model, then dispatches acquisition/activation/retention/monetization sub-orchestrators as needed.
---
...
- Keywords: growth strategy, growth model, AARRR, growth flywheel, growth system, user growth, growth bottleneck, growth diagnosis
