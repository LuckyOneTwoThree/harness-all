...
|---------|-----------|----------|------------|---------------|-------------------|-----------|--------|
| P01 | Home | P0 | — | docs/visual/home.md | docs/interaction/home.md | docs/prototype/wireframe-home.md | pending |
| P02 | Login | P0 | — | docs/visual/login.md | docs/interaction/login.md | - | pending |
| P03 | Dashboard | P0 | P02 | docs/visual/dashboard.md | docs/interaction/dashboard.md | docs/prototype/wireframe-dashboard.md | pending |
| P04 | Settings | P1 | P03 | docs/visual/settings.md | docs/interaction/settings.md | - | pending |
