...
mkdir -p docs/visual docs/ui docs/prototype docs/design-system docs/handoff/archive docs/handoff/receipts docs/handoff/packages
...
echo "  4. Edit docs/visual/DESIGN_BRIEF.md to fill in design requirements"
echo "  5. Edit docs/design-system/DESIGN.md to fill in the design system"
echo ""
