...
> Product research / engineering / growth are handled by other members of the harness family, handed off via `docs/handoff/`.
...
- Design skills: 14 (`.harness/skills/design/`)
- Meta skills: 4 (`.harness/skills/meta/`)
- Workflow orchestration (new design / iteration / redesign / handoff, etc.) is under `.harness/skills/workflows/`, read on demand.
...
| harness-ops | Ops / deployment / monitoring | No direct handoff (collaborates indirectly via pm) |
