...
> Generic craft rules (brand-agnostic) · referenced by ui-design (A1: replaces former visual-design) / design-system / verify (lint step)
>
...
- **ui-design** (A1: replaces former visual-design): cross-check forbidden pairings when choosing fonts
