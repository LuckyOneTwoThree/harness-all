...
- docs/ui/*.md (A1: all page combined visual + interaction drafts; formerly docs/visual/*.md + docs/interaction/*.md)
- docs/prototype/wireframe-*.md (all wireframes)
- docs/design-system/DESIGN.md
- docs/design-system/tokens.json
- docs/handoff/component-contract.json
- loops/specs/<task>/review-evidence.md (per-page consolidated evidence; product-design-review reads the `## Five-Axis Review` + `## WCAG Audit` sections)
- List of skipped pages (entries with Status = skipped in DESIGN_PLAN.md Section 2)

## Outputs
- loops/specs/<task>/review-evidence.md (appends `## Product-Level Review` section to the same consolidated file; no separate product-review-evidence.md)
...
- Read `docs/ui/<page>.md` (A1: combined visual + interaction)
...
- Grep all `docs/ui/*.md` for hardcoded hex colors (A1: combined file; formerly Grep docs/visual/*.md + docs/interaction/*.md)
...
Append a `## Product-Level Review` section to `loops/specs/<task>/review-evidence.md` (do NOT create a separate product-review-evidence.md file):
