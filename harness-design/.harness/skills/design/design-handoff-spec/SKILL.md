...
- `docs/ui/` (A1: combined visual + interaction; formerly `docs/visual/` + `docs/interaction/`), `docs/prototype/`
- `docs/design-system/DESIGN.md`
- `docs/design-system/tokens.json` and `tokens.css`
- `loops/specs/<task>/review-evidence.md` (consolidated: verify + lint + five-axis + WCAG + doubt-driven sections)
...
- `batch.type: full` for first-time design delivery; `batch.type: incremental` for any subsequent delivery (design-iteration, re-run, etc.)
...
- [ ] batch field populated per HANDOFF_PROTOCOL.md; ac_ids equals added + modified + unchanged
