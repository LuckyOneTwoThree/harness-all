...
> Update trigger: session-end syncs from task state; done is review-owned (code-review for delivery tasks, product-engineering-review for the product orchestrator).
