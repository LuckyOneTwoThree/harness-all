...
Prepare aggregated facts for session-end. Session-end alone publishes requested Engineering→PM packages; this workflow does not write the same handoff twice.
