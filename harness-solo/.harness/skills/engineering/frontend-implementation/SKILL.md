...
- Consuming a ready design-to-solo package and need to create/update engineering bindings (component-bindings.json) for frontend components.
- Family-mode frontend work requires a ready design package and valid semantic component contract (or a complete PM waiver with approver + reason + scope + review point).
