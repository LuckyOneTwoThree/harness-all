...
On verify-full start: write `stage: verify`, `status: running`, `substage: full-running` before executing the 4 check groups. Full pass writes `substage: full-passed`, and clears error: verified, awaiting code review. It does **not** mark done.
