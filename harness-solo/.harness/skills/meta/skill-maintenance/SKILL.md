...
3. **Consistency comparison**
   ...
   | Empty directory | Every subdirectory under engineering/meta must contain a SKILL.md or files | Mark "empty directory" |
   | Duplicate skill | The same skill name must not appear in both engineering and meta | Mark "duplicate" |
