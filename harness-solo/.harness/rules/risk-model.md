...
- Solo: ordinary code edit is R1; dependency/API/schema/security change is R2 or R3.
- Growth: draft content is R1; publishing or paid campaign launch is R2.
- Ops: inspection is R0; staging apply is R1/R2 by blast radius; production is R3.
